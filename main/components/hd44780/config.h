...
#define LCD_ADDR 1               /*!< Address of the display on the I2C bus. Set with menuconfig. */
#define LCD_ROWS 1               /*!< Number of rows in the display. Set with menuconfig. */
#define LCD_COLUMNS 1         /*!< Number of columns in the display. Set with menuconfig. */
